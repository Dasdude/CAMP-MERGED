function [] = plot_roadmap_transreciev(data_table,total_max_lines,folder_name,include_pl)
    ...
    data_table.RSS(data_table.RSS<-110) = -100;
    ...
    for d = distance_bin_size:distance_bin_size:500
        data_table_sub = data_table(data_table.Range<d&data_table.Range>d-distance_bin_size,:);
        ...
        x= table2array([data_table_sub(idx,'lat'),data_table_sub(idx,'long')]);
        y= table2array([data_table_sub(idx,'rx_lat'),data_table_sub(idx,'rx_long')]);
