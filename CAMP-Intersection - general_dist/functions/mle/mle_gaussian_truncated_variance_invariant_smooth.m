function [params,loss_val] = mle_gaussian_truncated_variance_invariant_smooth(params_mu_omega_init,data,per_rate,trunc_val,mu_lower_bound)
%MLE_NAKAGAMI_TRUNCATED Summary of this function goes here
%   Detailed explanation goes here
fun = @(x)loglikelihood_gaussian_variance_invariant_adptv_pdf_uniform(x,data,per_rate,params_mu_omega_init);
...
if isempty(data)
    ...
    [params,loss_val]=fmincon(fun,params_mu_omega_init,[],[],[],[],[-inf,0],[mean(data),inf],[],options);
% end
end
